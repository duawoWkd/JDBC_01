...
public class StudentVO {
	...
	public String getSt_weight() {
		return st_weight;
	}
	public void setSt_weight(String st_weight) {
	...
	public String getSt_dep_no() {
		return st_dep_no;
	}
	public void setSt_dep_no(String st_dep_no) {
		this.st_dep_no = st_dep_no;
	}
	@Override
	public String toString() {
		return "StudentVO [st_no=" + st_no + ", st_name=" + st_name + ", st_addr=" + st_addr + ", st_grade=" + st_grade
				...
				+ st_nick_rem + ", st_dep_no=" + st_dep_no + "]";
	}
